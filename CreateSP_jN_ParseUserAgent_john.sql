...
BEGIN
  ...
  set @phone_iPhone = '\biPhone\b|\biPod\b';
	...
	set @tablet_Surface ='Windows NT [0-9.]+; ARM;.*(Tablet|ARMBJS)';
	set @tablet_HP ='HP Slate (7|8|10)|HP ElitePad 900|hp-tablet|EliteBook.*Touch|HP 8|Slate 21|HP SlateBook 10';
	set @tablet_Asus ='^.*PadFone((?!Mobile).)*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T';
	...
	set @tablet_Lenovo = 'Idea(Tab|Pad)( A1|A10| K1|)|ThinkPad([ ]+)?Tablet|Lenovo.*(S2109|S2110|S5000|S6000|K3011|A3000|A3500|A1000|A2107|A2109|A1107|A5500|A7600|B6000|B8000|B8080)(-|)(FL|F|HV|H|)';
	...
	set @OS_iOS='\biPhone.*Mobile|\biPod|\biPad';
	set @OS_MeeGo= 'MeeGo';
	set @OS_Maemo= 'Maemo';
